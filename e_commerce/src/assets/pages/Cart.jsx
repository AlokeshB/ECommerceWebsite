...
const Cart = () => {
  // Destructure from context - ensure getCartCount is included
  const {
    cartItems,
    updateQuantity,
    removeFromCart,
  ...
  // Use optional chaining or defaults to prevent errors during empty states
            ...
            <div className="row g-4">
              <div className="col-lg-8">
                <div className="bg-white rounded shadow-sm overflow-hidden">
                  {cartItems.map((item) => (
                    // FIX: Key must be unique. If item.id is not unique, use index as fallback
                    <div
